...
config.bind(
    ',d', 'spawn --detach kitty yt-dlp {url}')
config.bind(
    ',D', 'hint links spawn --detach kitty yt-dlp {hint-url}')
config.bind(
    ',M', 'hint links spawn --detach qbittorrent {hint-url}')
...
# Type: FormatString
config.set('content.headers.user_agent',
           'Mozilla/5.0 ({os_info}; rv:131.0) Gecko/20100101 Firefox/131.0', 'https://accounts.google.com/*')
